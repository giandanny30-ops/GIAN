...
EMOJI_TO_BOX = {
    ...
    "<:e_memo:1519363057199878144>": "<:e_pencil:1519363059909398610>",
    ...
    "<:e_target:1519363069925654609>": "<:e_target:1519363069925654609>",
...
def _autoembed_color_for(text: str) -> int:
    ...
    if t.startswith(("<:e_coins2:1519362621206298666>", "<:e_coins2:1519362621206298666>", "<:e_bank2:1519362662515871744>", "<:e_moneywing:1519362955437805771>")):       return COLORS["gold"]
    return COLORS["info"]
